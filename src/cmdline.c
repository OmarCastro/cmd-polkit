/*
  ...
  /usr/bin/gengetopt --input=app.cmdline --include-getopt --no-handle-error 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->command_help = gengetopt_args_info_help[2] ;
  args_info->serial_help = gengetopt_args_info_help[3] ;
  args_info->parallel_help = gengetopt_args_info_help[4] ;
  args_info->verbose_help = gengetopt_args_info_help[5] ;
  args_info->quiet_help = gengetopt_args_info_help[6] ;
  args_info->silent_help = gengetopt_args_info_help[7] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->command_given)
    {
      fprintf (stderr, "%s: '--command' ('-c') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVc:spvq", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'c':	/* Command to execute on authorization request.  */
          ...
          break;
        case 's':	/* handle one authorization request at a time.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->serial_given),
              &(local_args_info.serial_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "serial", 's',
              additional_error))
            goto failure;
          ...
          break;
        case 'p':	/* handle authorization in parallel.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->parallel_given),
              &(local_args_info.parallel_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "parallel", 'p',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "silent") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->silent_given),
                &(local_args_info.silent_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "silent", '-',
                additional_error))
              goto failure;
